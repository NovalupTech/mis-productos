...
import { authenticateAdmin } from "@/actions/auth/admin-login";
...
export const AdminLoginForm = () => {
	const [state, dispatch] = useActionState(authenticateAdmin, undefined);
...
function AdminLoginButton () {
    ...
    return (
        <button 
            ...
            disabled={pending}
        >
            {pending ? 'Ingresando...' : 'Ingresar como Administrador'}
        </button>
    )
}
